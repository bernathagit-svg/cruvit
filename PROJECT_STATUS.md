...
| **5** | Global Plant Catalog Foundation v1 | **In progress** — foundations through … + Blueberry Identity Outcome Documentation Contract (pushed `b235782`) + Preference-versus-Tolerance Modeling Documentation Contract (pushed `ff54015`) + Evidence Packet / Field Review Reference Amendment Documentation Contract (local docs) + **Evidence Packet Reference Amendment** (implemented locally: EP contract/registry/validator **0.2.0** with explicit **0.1.0** compatibility; Field Review unchanged); catalog task **B Frozen (v1)**; Field Review foundations closed/empty/non-authoritative; **36/36/36** unchanged; all **23** conflicts blocked; blueberry parent remains blocked; real packets **0**; real field-review records **0**; matchers/UI blocked; GOS paused; next = push EP amendment + isolated production verification, then Field Review Reference Amendment + Inert Structured Climate Profile / Global Climate Schema Planning (deferred), then evidence-backed cleanup batches + re-audit, then matcher (separately gated), then **C–E** |
...
## High
- **Smart Recommendations sun/water readiness** — Evidence Packet Reference Amendment implemented locally (EP **0.2.0** with explicit **0.1.0** compatibility; Field Review unchanged); Field Review foundations closed/empty/non-authoritative; Blueberry identity outcome documented (pushed `b235782`; split + broad unknown parent, not implemented); Preference-versus-Tolerance Modeling Documentation Contract closed (pushed `ff54015`); Reference Amendment Documentation Contract closed locally; blueberry parent remains blocked; real packets **0**; real field-review records **0**; **36/36/36** legacy only; **23** conflicts remain blocked; matchers/UI blocked; GOS paused; next: push EP amendment + production verification → deferred Field Review Reference Amendment + Inert Structured Climate Profile / Global Climate Schema Planning → evidence-backed cleanup batches → re-audit → matcher (each separately gated; UI not started)
...
**Done (pushed):** Field Review + Evidence Packet foundations through Evidence Packet Validator (`17cf753` / prod docs `2994693`) + Blueberry Identity-Scope Evidence Planning (`4361021`) + Blueberry Identity Outcome Documentation Contract (`b235782`) + Preference-versus-Tolerance Modeling Documentation Contract (`ff54015`).
...
**Done (local docs):** Evidence Packet / Field Review Reference Amendment Documentation Contract — shared EP/FR reference semantics frozen; docs push may still be pending separately.

**Done (local impl):** Smart Recommendations — Evidence Packet Reference Amendment — inert 0.2.0 contract/registry/validator/harness amendment with explicit 0.1.0 compatibility; Field Review unchanged; realPacketCount **0**; no product authority. Local commit pending push.

**Next (separately gated):** Push the Evidence Packet Reference Amendment implementation commit, then isolated production verification of the 0.2.0 Evidence Packet modules/harnesses (no Field Review change; no deploy settings; no real packets).

**Then (deferred, not authorized):** Field Review Reference Amendment → Inert Structured Climate Profile / Global Climate Schema Planning → evidence-backed cleanup batches → re-audit → matcher. UI remains blocked. GOS remains paused. Do **not** begin the Field Review Reference Amendment, create packets or Field Review records, clear needsReview, edit catalog/schema/`index.html`, implement Blueberry children, implement sun/water matchers, or enable filter UI without separate approval.
