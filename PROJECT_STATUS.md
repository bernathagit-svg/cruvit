...
## High
- Phase C2 — smallest inert developer-only in-memory My Garden canonical identity Sidecar (Phase C1 production verified at `d239249`; Sidecar stopped by default; explicit consult only; no consumers / auto-population / persistence / UI / authority)
