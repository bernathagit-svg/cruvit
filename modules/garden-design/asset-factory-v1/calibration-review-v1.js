...
<body>
  ...
  <p id="realGardenBanner" class="warn">Waiting for authenticated host to inject the temporary Garden Design source signed URL. Path: garden_designs.source_media_id → garden_media → private ${esc(
