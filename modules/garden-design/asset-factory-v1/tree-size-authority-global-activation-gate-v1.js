...
export function evaluateTreeSizeAuthorityGlobalActivationGate(registry) {
  ...
  const checks = {
    ...
    globalFlagOff: GARDEN_SIZE_AUTHORITY_ACTIVATION.globalAuthorityRuntimeEnabled === false,
    productionGardenOff: GARDEN_SIZE_AUTHORITY_ACTIVATION.applyInProductionGardenDesign === false,
    productionHelperOff: productionGardenSizeAuthorityEnabled() === false,
    canaryRemainsTrue: GARDEN_SIZE_AUTHORITY_ACTIVATION.canaryAuthorityRuntimeEnabled === true,
    inactiveWithoutGate: resolveGardenSizeAuthority(registry, { canonicalSlug: 'cedar' }).applied === false,
