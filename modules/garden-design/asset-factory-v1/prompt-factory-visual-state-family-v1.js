...
export function familyLockLines(job = {}) {
  ...
  return [
    ...
    'FRAMING SAFE ZONE: the complete visible specimen must sit comfortably inside the canvas and must not touch any image boundary. Leave clearly visible transparent breathing room on every side, with especially generous space above the highest leaf/branch and at both lateral extremes. Target at least ~4% transparent top margin, ~2.5% on each side, and ~1% at the bottom so the production framing gate has safety buffer. Do not crop leaves, branches, fruit, flowers, stems, or roots at the canvas edge.',
