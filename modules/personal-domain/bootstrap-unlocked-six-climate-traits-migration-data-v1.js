...
export const BOOTSTRAP_UNLOCKED_SIX_CLIMATE_TRAITS_MIGRATION_V1 = {
  ...
  "sourceTruth": {
    "apple": {
      ...
      "absentCore": [],
      "floweringPresent": true,
      "fruitingPresent": true,
      "sourceAudit": {
        "groupExplicit": {
          "frostSensitivity": {
            "groupId": "temperate-chill-fruit-tree",
            "value": "low"
          },
          "coldTolerance": {
            "groupId": "temperate-chill-fruit-tree",
          ...
          "floweringRequirements": {
            "groupId": "temperate-chill-fruit-tree",
            "value": "Needs full sun plus a real cool-season / winter dormancy signal for reliable bloom."
          },
          "fruitingRequirements": {
            "groupId": "temperate-chill-fruit-tree",
            "value": "Reliable fruiting needs winter chill or clear cool-season conditions; always-hot tropical climates are not a confident match."
          },
          "survivalVsThriveNotes": {
            "groupId": "temperate-chill-fruit-tree",
            "value": "May survive as a tree in some warm locations, but reliable flowering and fruiting depend on winter chill / cool-season cueing."
          },
          "needsWinterChill": {
            "groupId": "temperate-chill-fruit-tree",
            "value": true
    ...
    "fig": {
      ...
      "sourceAudit": {
        "groupExplicit": {
          "frostSensitivity": {
            "groupId": "warm-dry-mediterranean-fruit",
            "value": "medium"
          },
          "coldTolerance": {
            "groupId": "warm-dry-mediterranean-fruit",
          ...
          "floweringRequirements": {
            "groupId": "warm-dry-mediterranean-fruit",
            "value": "Best flowering comes with full sun, airflow, and a clear dry-season rhythm."
          },
          "fruitingRequirements": {
            "groupId": "warm-dry-mediterranean-fruit",
            "value": "Reliable fruiting prefers warm dry seasons, deep but not constant watering, and good drainage."
          },
          "survivalVsThriveNotes": {
            "groupId": "warm-dry-mediterranean-fruit",
            "value": "Often adaptable in warm climates, but fruit quality is strongest where summers stay sunny and relatively dry."
          },
          "needsDrySeason": {
            "groupId": "warm-dry-mediterranean-fruit",
            "value": true
    ...
    "grapevine": {
      ...
      "sourceAudit": {
        "groupExplicit": {
          ...
          "survivalVsThriveNotes": {
            "groupId": "support-dependent-plant",
            "value": "Needs a fence, wall, pole, trellis, or similar support instead of open-lawn placement."
          },
          "needsDrySeason": {
            "groupId": "warm-dry-mediterranean-fruit",
            "value": true
    ...
    "passionfruit": {
      ...
      "sourceAudit": {
        "groupExplicit": {
          "frostSensitivity": {
            "groupId": "subtropical-fruiting-climber",
            "value": "high"
          },
          "coldTolerance": {
            "groupId": "subtropical-fruiting-climber",
          ...
          "floweringRequirements": {
            "groupId": "subtropical-fruiting-climber",
            "value": "Warmth, sun, and a real support structure matter more than simple climate matching alone."
          },
          "fruitingRequirements": {
            "groupId": "subtropical-fruiting-climber",
            "value": "Reliable fruiting needs warmth, regular water, support, and protection from frost or hard wind."
          },
          "survivalVsThriveNotes": {
            "groupId": "support-dependent-plant",
            "value": "Needs a fence, wall, pole, trellis, or similar support instead of open-lawn placement."
  ...
  "plants": {
    ...
    "passionfruit": {
      ...
      "climateTraits": {
        ...
        "waterNeeds": "medium",
        "floweringRequirements": "Warmth, sun, and a real support structure matter more than simple climate matching alone.",
        "fruitingRequirements": "Reliable fruiting needs warmth, regular water, support, and protection from frost or hard wind.",
        "survivalVsThriveNotes": "Needs a fence, wall, pole, trellis, or similar support instead of open-lawn placement.",
        "hardBlockRules": [
          "needs-support"
        ],
        ...
        "migration": {
          ...
          "sources": [
            {
              "type": "group",
              "id": "subtropical-fruiting-climber"
            },
            {
              "type": "group",
              "id": "support-dependent-plant"
