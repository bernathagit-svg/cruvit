  ...
  for(const item of bundle.jobs||[]){
    ...
    jobs.push({
      ...
      qaRendererInput:{
        ...
        source:'presentation-sizing-v1.1+relative-preview-scale-v1.1+in-garden-qa-scale-policy-v1.1',
        ...
        relativePreviewScaleResponseProfile:relativePreview.responseProfile||null,
        relativePreviewScaleResponseExponent:relativePreview.responseExponent||null,
