...
Save-Crop 'card-garden-design-center.png' 292 458 442 674 48
Save-Crop 'card-my-garden-side.png' 0 535 281 539 38
Save-Crop 'card-plant-doctor-side-alt.png' 744 542 280 532 38
$img.Dispose()
Write-Output 'alt-cropped-ok'